...
const About =()=>{
    const data = [
        ...
        },
        {
            ...
            description: "Intervalle has a vision to participate to the game changer of the Agricultural sector in West Africa by providing agricultural related " +
                "innovative solutions with first class coalition strategic and technical partners in an integrated value c hain approach."
        },
        {
            title: 'Objective',
    ...
    return(
        ...
        <section className="" id="About">
           ...
           {/*    <img className="w-full md:w-1/2 " src="images/VALUE.jpg" alt={''}/>*/}
           {/*    <div className={'md:w-2/3 lg:w-1/2'}>*/}
           {/*        <h5 className="mb-1 text-3xl font-medium text-black mb-3">About</h5>*/}
           {/*        <p>*/}
                ...
                data.map((item, index) => (
                    <div className={`w-full max-w-sm bg-white straight-lg ${index === 0 ? 'text-white p-5 px-8 bg-green-600' : ''}`}>
                        <div className="flex flex-col items-start pt-4 pb-10">
                            <h5 className="mb-1 text-3xl font-medium mb-3">{item.title}</h5>
                ...
                values.map((item, index) => (
                    <div key={index} className={'flex gap-3 items-start justify-start my-5'}>
                        <div className={'flex items-center justify-center p-[5px] rounded-full bg-green-600/30'}>
                            <GoCheck size={18} className={'text-white font-bold text-green-600'}/>
                        </div>
                        <div>
