...
<div class="relative md:text-base">
        ...
        <div class="text-white bg-lime-600 p-3">THE GOOD GROWTH PLAN</div>
        </h2>
        <h3 class="absolute text-8xl text-white bottom-40 left-5 ">Establish Bankable and
Sustainable Full Value
Chain Projects</h3>
    </div>
...
in Ghana and other countries in the sub region, Intervalle Ghana sees a significant opportunity to
contribute to boost local rice production and fill the demand gap and improve rice self-sufficiency ratio
in West Africa. To be able to do this effectively and efficiently, the company would need to overcome
