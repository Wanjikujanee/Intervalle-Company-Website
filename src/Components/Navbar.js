              ...
              <div className="container px-4 mx-auto flex flex-wrap items-center justify-between">
                ...
                <div className=" hidden md:flex flex-grow items-center" id="example-navbar-warning">
                  <ul className="flex flex-col lg:flex-row list-none ml-auto">
                      ...
                      <button type="button" class="py-2.5 px-5 mr-2 mb-2 text-sm font-medium text-red-800 bg-white rounded-lg border hover:bg-red-600 hover:text-white    dark:bg-red-400  ">Search</button>
