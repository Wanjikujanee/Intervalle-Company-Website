...
const Project = () => {
    const projects = [
        ...
        {
            text: "Intervalle Genève S.A, partnered and signed an agreement with the Ministry of Food and Agriculture (MOFA) in July, 2018 to co-execute Planting for Food and Jobs- the Rice Chapter. Intervalle Ghana ltd leads the implementation of the in-growers schemes proof of concept with first class coalition partners in two selected areas in Ghana ensuring the full value chain approach is successfully implemented which will allow scaling up and replication in Ghana and other ECOWAS countries.",
        },
        {
